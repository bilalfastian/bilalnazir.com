module.exports = {
  ...
  siteRssAuthor: "Bilal Nazir", // The author name used in the RSS file
  // siteFBAppID: "1825356251115265", // optional, sets the FB Application ID for using app insights
  sitePaginationLimit: 10, // The max number of posts per page.
  googleAnalyticsID: "UA-111456803-1", // GA tracking ID.
  // disqusShortname: "https-vagr9k-github-io-gatsby-advanced-starter", // enables Disqus comments, visually deviates from original Casper theme.
  siteSocialUrls: [
    "https://www.linkedin.com/in/bilalfastian",
    "https://github.com/bilalfastian",
    "https://twitter.com/bilalnazir90",
    "mailto:bilal.nazirahmad@gmail.com"
  ],
  ...
  userLinks: [
    {
      label: "GitHub",
      url: "https://github.com/bilalfastian",
      iconClassName: "fa fa-github" // Disabled, see Navigation.jsx
    },
    {
      label: "Twitter",
      url: "https://twitter.com/bilalnazir90",
  ...
  copyright: {
    label: "Build by Bilal Nazir" // Label used before the year
